...
assert_equal(parse("[1- 2]"), { "-", 1, 2 })
assert_equal(parse("[1 -2]"), { " ", 1, -2 })
assert_equal(parse("[50 1 - 2]"), { " ", 50, { "-", 1, 2 } })
assert_equal(parse("[50 1-2]"), { " ", 50, { "-", 1, 2 } })
assert_equal(parse("[50 1- 2]"), { " ", 50, { "-", 1, 2 } })
assert_equal(parse("[50 1 -2]"), { " ", 50, 1, -2 })
assert_equal(parse("[1 - 2 50]"), { " ", { "-", 1, 2 }, 50 })
assert_equal(parse("[1-2 50]"), { " ", { "-", 1, 2 }, 50 })
assert_equal(parse("[1- 2 50]"), { " ", { "-", 1, 2 }, 50 })
assert_equal(parse("[1 -2 50]"), { " ", 1, -2, 50 })
assert_equal(parse("[25 1 - 2 50]"), { " ", 25, { "-", 1, 2 }, 50 })
assert_equal(parse("[25 1-2 50]"), { " ", 25, { "-", 1, 2 }, 50 })
assert_equal(parse("[25 1- 2 50]"), { " ", 25, { "-", 1, 2 }, 50 })
assert_equal(parse("[25 1 -2 50]"), { " ", 25, 1, -2, 50 })
...
assert_equal(DogTag:ColorizeCode("[or]"), "|cffffffff[|r|cff7f7fffor|r|cffffffff]|r")
...
assert_equal(DogTag:ColorizeCode("[Tag(Arg, Other)]"), "|cffffffff[|r|cff00ffffTag|r|cffffffff(|r|cff00ffffArg|r|cffffffff,|r |cff00ffffOther|r|cffffffff)|r|cffffffff]|r")
assert_equal(DogTag:ColorizeCode("[Tag(kw=Arg)]"), "|cffffffff[|r|cff00ffffTag|r|cffffffff(|r|cffff0000kw|r|cff7f7fff=|r|cff00ffffArg|r|cffffffff)|r|cffffffff]|r")
assert_equal(DogTag:ColorizeCode("[Tag:Mod]"), "|cffffffff[|r|cff00ffffTag|r|cff7f7fff:|r|cff00ff00Mod|r|cffffffff]|r")
assert_equal(DogTag:ColorizeCode("hello [Tag:Mod] hello"), "|cffff7f7fhello |r|cffffffff[|r|cff00ffffTag|r|cff7f7fff:|r|cff00ff00Mod|r|cffffffff]|r|cffff7f7f hello|r")
assert_equal(DogTag:ColorizeCode("[(Tag)]"), "|cffffffff[|r|cffffffff(|r|cff00ffffTag|r|cffffffff)|r|cffffffff]|r")
assert_equal(DogTag:ColorizeCode("[42]"), "|cffffffff[|r|cffff00ff42|r|cffffffff]|r")
